...
const toolbarVariants = cva(
  "flex w-full items-center justify-between bg-muted/60",
  {
    variants: {
      size: {
        sm: "px-1 py-0.5",
...
export const ToolbarButton = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof ToolbarPrimitive.Button> & VariantProps<typeof toolbarButtonVariants> & { asChild?: boolean }
